...
;	orl		TMOD,		#00000001b	; Timer0 mode
	;				     ||||
	;				     ||++-------- Timer0 mode (01 - 16-bit, 10 - 8-bit with auto-reload, 11 - not available, functions the same as 01)
	;				     |+---------- T/C0: 0 - timer, 1 - counter
	;				     +----------- Gate_T0: 0-control by TR0, 1-control by TR0 & INT0
	
;	orl		TCON,		#00000101b	; Timer0 control
	;				   ||||||
